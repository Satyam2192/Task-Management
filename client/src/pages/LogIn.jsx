    ...
    <section className="flex flex-col md:flex-row h-screen items-center">
      ...
      <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
        <div className="w-full h-100">
          <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Sign Up for an account</h1>
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            >
              {loading ? <div className=' items-center flex justify-center'>
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-live="polite" aria-busy="true" aria-labelledby="title-08a desc-08a" className="w-6 h-6">
